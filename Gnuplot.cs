...
namespace GnuPlotHelpers
{
    class GnuPlot
    {
        ...
        public static string PathToSaveDirectory = @"C:\gnuplots";
        ...
        public static void SetTerminalToSaveToFile(string nazwaPliku)
        {
            GnupStWr.WriteLine("set terminal png size 800, 600");
            GnupStWr.WriteLine($"set output '{PathToSaveDirectory}\\{nazwaPliku}.png'");
            GnupStWr.Flush();
        }

        public static void SetTitle(string tytul)
        {
            GnupStWr.WriteLine($"set title \"{tytul}\"");
            GnupStWr.WriteLine("show title");
            GnupStWr.Flush();
        }
        ...
        public static void HoldOn(string nazwaPliku = null)
        {
            Hold = true;
            PlotBuffer.Clear();
            SPlotBuffer.Clear();
